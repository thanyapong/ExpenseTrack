...
import { FormikFocusError } from "../../_common/components/FormikFocusError";

type FormikAutocompleteApiDefaultFilterProp = {
    formik: FormikProps<any>;
    name: string;
    label: string;
    useQueryGet: (defaultFilter: any, filter: any, defaultId: any) => UseQueryResult<{ [key: string]: any }[], unknown>;
...
const FormikAutocompleteApiDefaultFilter = ({
    formik,
    name,
    label,
    useQueryGet,
    ...
    defaultFilter,
    ...formControlProps
}: FormikAutocompleteApiDefaultFilterProp) => {
    const { touched, value, error } = formik.getFieldMeta<string | number | undefined>(name);
    const { setFieldValue, setFieldTouched } = formik;

    const [searchText, setSearchText] = useState("");

    const { data: options, isLoading: loading, isError } = useQueryGet(defaultFilter, searchText, value);
...
export default FormikAutocompleteApiDefaultFilter;
